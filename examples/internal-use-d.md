# Internal-use-D example

This example shows the strongest internal-use reciprocity posture. It requires
public release of the exact internally used covered work, materially integrated
internal systems, and the non-secret operational materials needed to reproduce
substantially equivalent combined operation.

## Good fit

- Projects that want maximal transparency for internal deployments
- Stewards that view integrated internal systems as part of the reciprocal deal

## Bad fit

- Organizations with substantial proprietary internal integrations
- Projects seeking a lighter internal-use compromise
...
Copyright Holder(s):
Foundry Mesh Systems

Contact for Legal Notices:
legal@foundrymesh.example

Primary Public Repository:
https://git.example/foundry-mesh/runtime
...
[x] MOD-INT-D  Internal Use, Public Integrated-System Release Variant
...
https://developer.foundrymesh.example/extensions

Integral Component Designations Beyond the Default Definition:
The internal policy engine and orchestration coordinator are designated Integral
Components for production deployments.
...
Integrated internal deployment materials are expected to be published whenever
MOD-INT-D requires public release of the exact internally used system.
```
