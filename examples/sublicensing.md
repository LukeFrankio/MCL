...
- Single-rightsholder projects planning dual licensing
- Projects whose steward already controls all relevant rights
...
Copyright Holder(s):
Studio Render Core, Inc.

Contact for Legal Notices:
legal@studiorendercore.example

Primary Public Repository:
https://source.example/studio-render/core
